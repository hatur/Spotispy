================================================================================
    MICROSOFT FOUNDATION CLASS-BIBLIOTHEK: Spotispy-Projektübersicht
===============================================================================

Diese Spotispy-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt. Diese Anwendung zeigt nicht nur die Grundlagen der Verwendung von Microsoft Foundation Classes, sondern dient auch als Ausgangspunkt für das Schreiben Ihrer Anwendung.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Spotispy-Anwendung besteht.
...
Spotispy.h
    ...
    Sie enthält andere projektspezifische Header (einschließlich Resource.h) und deklariert die CSpotispyApp-Anwendungsklasse.

Spotispy.cpp
    Dies ist die wichtigste Anwendungsquelldatei, die die Anwendungsklasse CSpotispyApp enthält.
...
res\Spotispy.ico
    Dies ist eine Symboldatei, die als Anwendungssymbol verwendet wird. Dieses Symbol ist in der Hauptressourcendatei Spotispy.rc enthalten.
...
SpotispyDlg.h, SpotispyDlg.cpp - das Dialogfeld
    Diese Dateien enthalten Ihre CSpotispyDlg-Klasse. Diese Klasse definiert das Verhalten des Hauptdialogfelds der Anwendung. Die Vorlage für das Dialogfeld befindet sich in Spotispy.rc und kann in Microsoft Visual C++ bearbeitet werden.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Spotispy.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
